...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case KFU_TRAYICON:
	{
		if (lParam == WM_RBUTTONDOWN || lParam == WM_LBUTTONDOWN)
		{
			...
			AppendMenu(popup, MF_STRING | (Settings::UnlockClient ? MF_CHECKED : 0), KFU_TRAYMENU_CLIENT, "Unlock Bloxxia Player");
			AppendMenu(popup, MF_STRING | (Settings::UnlockStudio ? MF_CHECKED : 0), KFU_TRAYMENU_STUDIO, "Unlock Bloxxia Studio");
...
#ifdef _WIN64
	SetConsoleTitleA("Bloxxia FPS Unlocker " KFU_VERSION " Console");
#endif
...
{	
	...
	UI::Window = CreateWindow("KFUClass", "Bloxxia FPS Unlocker", 0, 0, 0, 0, 0, NULL, NULL, instance, NULL);
	if (!UI::Window)
		return 0;
	...
	strcpy_s(NotifyIconData.szTip, "Bloxxia FPS Unlocker");
